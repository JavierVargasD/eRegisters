...
function onDeviceReady() {
	...
	if( window.localStorage.getItem("post") === 'true' ){
		query = "SELECT * FROM post_vivienda_p where id=" + ac;
	}
	 ...
	 pdf.htmlToPDF({
	    ...
	    + "	}" 
          ...
          + "  <tr>"
			...
			+ "      <td style='width: 80%;height:75px;text-align:center;font-size:18px'>ACTA POST REGISTRO DE VIVIENDA</td>"
            ...
            + "  <td style='width: 12.5%'>  POST-VIV-" + $("#customActa").val() +" </td>"
			...
			+ "Una vez comprobada las condiciones estructurales de la vivienda ubicada en el predio "+ $("#predio").val() 
			...
			+ " de " + $("#lugar_cc_propietario").val() + ", como propietario o representante del predio, el día  " + ($("#dia").val())+" del mes de " + ($("#mes").val())+" del año " + ($("#ann").val())
			+"  con el fin de comprobar y manifestar que la Vivienda y construcciones anexas referenciadas en el acta pre-registro Codigo PRE-VIV-" + $("#customActa").val() +", " + ($("#enca").val())
          ...
          + "  <tr>"
            ...
            + " </tr>"
            + " <tr>"
            + "     <td colspan='5'>Los presentes firman en constancia de la evaluación realizada y las partes se declaran entre si, a paz y salvo por todo concepto y responsabilidad en especial en lo referente a las afectaciones a la vivienda y/o construcciones anexas. Para constancia se firma siendo las _________ horas del día ___________ del mes de  ______________ de 201___.</td>"
            + " </tr>"
            + "<tr>"
            ...
            + "       <tbody>"
            + "            <tr>"
            + "              <td class='rotate'><div>POST-VIV-"+(padDigits($("#customActa").val(), 3))+"-02</div></td>"
            + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/post-viv-" + ac +"-"+ 2 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
            + "              <td  class='rotate'><div>POST-VIV-"+(padDigits($("#customActa").val(), 3))+"-01</div></td>"
            + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/post-viv-" + ac +"-"+ 1 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
            + "            </tr>"
            + "            <tr>"
            + "              <td class='rotate'><div>POST-VIV-"+(padDigits($("#customActa").val(), 3))+"-04</div></td>"
            + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/post-viv-" + ac +"-"+ 4 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
            + "              <td  class='rotate' ><div>POST-VIV-"+(padDigits($("#customActa").val(), 3))+"-03</div></td>"
            + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/post-viv-" + ac +"-"+ 3 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
            + "            </tr>"
            + "         </tbody>"
            + "       </table></p>"	
            + "     <p style='page-break-after: always;'> "
            ...
            + "            <tr>"
            + "            <tr>"
            + "              <td class='rotate' style='height:650px;width:30px;'><div>POST-VIV-"+(padDigits($("#customActa").val(), 3))+"-06</div></td>"
            + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/post-viv-" + ac +"-"+ 6 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
            + "              <td  class='rotate' style='height:650px;width:30px;'><div>POST-VIV-"+(padDigits($("#customActa").val(), 3))+"-05</div></td>"
            + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/post-viv-" + ac +"-"+ 5 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
            + "            </tr>"
            + "            <tr>"
            + "              <td class='rotate' style='height:650px;width:30px;'><div>POST-VIV-"+(padDigits($("#customActa").val(), 3))+"-07</div></td>"
            + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/post-viv-" + ac +"-"+ 7 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
            + "              <td  class='rotate' style='height:650px;width:30px;'><div>POST-VIV-"+(padDigits($("#customActa").val(), 3))+"-08</div></td>"
            + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/post-viv-" + ac +"-"+ 8 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
            + "            </tr>"
            + "         </tbody>"
            + "       </table></p>"			
            + "    </body>"
...
function resolveOnSuccess(entry){ 
    ...
    var n = d.getTime();
    //new file name
    var newFileName = 'post-viv-' + ac +'-'+ vivImageNumber + ".jpg";
    i++;
    
    var dir = '/';
    window.localStorage.setItem('post-viv-' + ac +'-'+ vivImageNumber,'');
...
function insertDataPreVivienda() {
    ...
    if (window.localStorage.getItem("editar") === 'true') {
        ...
        var executeQuery = "UPDATE post_vivienda_p SET "
                + "vereda=?,"
                + "predio=?,"
                + "propietario=?,"
                + "cc_propietario=?,"
        ...
        myDB.transaction(function(transaction) {
            var executeQuery = "INSERT INTO post_vivienda_p ("
                    + "id,"
                    + "programa_sismico,"
                    + "operadora,"
                    + "fecha,"
