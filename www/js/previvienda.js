	 ...
	 pdf.htmlToPDF({
	    ...
	    + "	}" 
          ...
          + "  <tr>"
            ...
            + "            <tbody>"
            + "                <tr>"
            + "                    <td style='width:40%' class='encabezado'>Localizaci&#243;n</td>"
            + "                    <td style='width:31%' class='encabezado'>Ubicaci&#243;n</td>"
            + "                    <td style='width:29%' class='encabezado'>Procesos erosivos cercanos</td>"
            + "                </tr>    "
            + "            </tbody>"
            + "        </table>"
            + "        <table width='100%' border='1' cellspacing='0' cellpadding='0'>"
            ...
            + "                    <td style='width:28%' >" + $("#P_DEPTO option:selected").text() + "</td>"
          ...
          + "  <tr>"
            ...
            + " </tr>"
            + " <tr>"
            + "     <td colspan='5'>Los presentes están de acuerdo con la evaluación efectuada y en constancia firman siendo las _______ horas del día ___________ del mes de ______________ de 202___.</td>"
            + " </tr>"
            + "<tr>"
