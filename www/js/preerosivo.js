...
function generatePDF() {
    ...
    var failure = function(status) {
     ...
     pdf.htmlToPDF({
			...
			+ "     <td style='width:10%,text-align:center'> " + ($("#estado_inactivo").is(':checked') ? "X" : "") + " </td>"
			...
			+ "       </tr>"
			+ "        <tr>"
			+ "    <td style='width:50%' rowspan='11'><img  src='file:///storage/emulated/0/Download/infraLine.png' style='width: 99%;  height: auto;'></td>"
			...
			+ "    <td style='width:10%,text-align:center'> " + ($("#socava_leve").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%,text-align:center'> " + ($("#socava_moderada").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%,text-align:center'> " + ($("#socava_severa").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%,text-align:center'> " + ($("#socava_muysevera").is(':checked') ? "X" : "") + " </td>"
			+ " </tr>   "
			+ " <tr>"
