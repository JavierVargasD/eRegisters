    ...
    var failure = function(status) {
     ...
     pdf.htmlToPDF({
			...
			+ "<body>"                
                        ...
                        + "      <td style='width: 80%;height:75px;text-align:center;font-size:18px'>ACTA PRE REGISTRO PROCESO EROSIVO</td><td>FR-QHSE-28<p style='font-size:11px'>V2  23-03-2018</p></td></tr></tbody></table></td>"
                        + "   </tr>"
                        + "   <tr>"
                        ...
                        + "  <td style='width: 12.5%'>  pre-ero-" + $("#customActa").val() +" </td>"
                        + "   </tr>    "
                        + "  </tbody>"
                        + "</table>"
			...
			+ "     <td style='width:10%'> " + ($("#estado_activo").is(':checked') ? "X" : "") + " </td>"
			...
			+ "     <td style='width:10%'> " + ($("#estado_inanctivo").is(':checked') ? "X" : "") + " </td>"
			...
			+ "     <td style='width:10%'> " + ($("#estado_estabilizado").is(':checked') ? "X" : "") + " </td>"
			...
			+ "     <td style='width:10%'>   " + ($("#uni_terraza").is(':checked') ? "X" : "") + " </td>"
			+ "       <td style='width:10%'>Llanura aluvial:</td>"
			+ "     <td style='width:10%'>  " + ($("#uni_llanura").is(':checked') ? "X" : "") +" </td>     "
			+ "       </tr>"
			+ "<tr>"
			...
			+ "     <td style='width:10%'>  " + ($("#uni_coluvion").is(':checked') ? "X" : "") +" </td>"
			+ "       <td style='width:10%'>Loma o colina:</td>"
			+ "     <td style='width:10%'>  " + ($("#uni_loma").is(':checked') ? "X" : "") +" </td>     "
			+ "       </tr>"
			+ "     </tbody>"
			+ "</table>"
			+ "       <table width='100%' border='1' cellspacing='0' cellpadding='0'>"
			...
			+ "    <td style='width:20%' colspan='2'>Verano:  " + ($("#periodo_verano").is(':checked') ? "X" : "")+" </td>"
			+ "    <td style='width:12%' rowspan='4'>Deslizamiento</td>"
			+ "    <td style='width:12%'>Rotacional:</td>"
			+ "    <td style='width:6%'> " + ($("#rotacional").is(':checked') ? "X" : "") + "</td>"
			+ "   </tr>"
			+ "<tr>"
			+ "    <td style='width:20%' colspan='2'>Invierno:  " + ($("#periodo_invierno").is(':checked') ? "X" : "")+" </td>"
			+ "    <td style='width:12%'>Traslacional:</td>"
			+ "    <td style='width:6%'> " + ($("#traslacional").is(':checked') ? "X" : "") + "</td>"
			+ "   </tr>"
			+ "<tr>"
			+ "    <td style='width:20%' class='encabezado' colspan='2'><b>10. USOS DEL SUELO</b></td>"
			+ "    <td style='width:12%'>Complejo:</td>"
			+ "    <td style='width:6%'> " + ($("#complejo").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "   </tr>"
			+ "<tr>"
			+ "    <td style='width:16%'>Bosque primario</td>"
			+ "    <td style='width:4%'> " + ($("#bosque_primario").is(':checked') ? "X" : "") + "</td>"
			+ "    <td style='width:12%'>Otro:</td>"
			+ "    <td style='width:6%'> " + ($("#masa_otro").val())+"</td>"
			+ "   </tr>"
			+ " <tr>"
			+ "    <td style='width:16%'>Bosque secundario</td>"
			+ "    <td style='width:4%'> " + ($("#bosque_secundario").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "    <td style='width:24%' colspan='2'>Caida de rocas y/o detritos</td>"
			+ "    <td style='widht:6%'> " + ($("#caida_rocas").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "   </tr>"
			+ "<tr>"
			+ "    <td style='width:16%'>Bosque de galería</td>"
			+ "    <td style='width:4%'> " + ($("#bosque_galeria").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "    <td style='width:24%' colspan='2'>Volcamiento</td>"
			+ "    <td style='widht:6%'> " + ($("#volcamiento").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "   </tr>"
			+ "<tr>"
			+ "    <td style='width:16%'>Rastrojo</td>"
			+ "    <td style='width:4%'> " + ($("#rastrojo").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "    <td style='width:12%' rowspan='3'>Flujos</td>"
			+ "    <td style='width:12%'>Escombros:</td>"
			+ "    <td style='width:6%'> " + ($("#flujos_escombros").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "</tr>"
			+ "<tr>"
			+ "    <td style='width:16%'>Cultivos</td>"
			+ "    <td style='width:4%'> " + ($("#cultivos").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "    <td style='width:12%'>Lodo:</td>"
			+ "    <td style='width:6%'> " + ($("#flujos_lodo").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "   </tr>"
			+ "<tr>"
			+ "    <td style='width:16%'>Pastos</td>"
			+ "    <td style='width:4%'> " + ($("#pastos").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "    <td style='width:12%'>Detrítos:</td>"
			+ "    <td style='width:6%'> " + ($("#flujos_detritos").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "   </tr>"
			+ "<tr>"
			+ "    <td style='width:16%'>Eriales</td>"
			+ "    <td style='width:4%'> " + ($("#eriales").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "    <td style='width:24%' colspan='2'>Reptación</td>"
			+ "    <td style='width:6%'> " + ($("#reptacion").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "   </tr>"
			+ " <tr>"
			...
			+ "    <td style='width:6%'> " + ($("#terraceras").is(':checked') ? "X" : "") + " "
			+ "</td>"
			+ "   </tr>"
			+ "</tbody>"
			+ "</table>"
			...
			+ "    <td style='width:10%'> " + ($("#laminar_leve").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#laminar_moderada").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#laminar_severa").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#laminar_muysevera").is(':checked') ? "X" : "") + " </td>"
			+ " </tr>   "
			+ " <tr>"
			+ "    <td style='width:10%'>En surcos:</td>"
			+ "    <td style='width:10%'> " + ($("#surco_leve").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#surco_moderada").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#surco_severa").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#surco_muysevera").is(':checked') ? "X" : "") + " </td>"
			+ " </tr>   "
			+ " <tr>"
			+ "    <td style='width:10%'>En cárcavas:</td>"
			+ "    <td style='width:10%'> " + ($("#carcavas_leve").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#carcavas_moderada").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#carcavas_severa").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#carcavas_muysevera").is(':checked') ? "X" : "") + " </td>"
			+ " </tr>   "
			+ " <tr>"
			+ "    <td style='width:10%'>Socavamiento:</td>"
			+ "    <td style='width:10%'> " + ($("#socavamiento_leve").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#socavamiento_moderada").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#socavamiento_severa").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#socavamiento_muysevera").is(':checked') ? "X" : "") + " </td>"
			+ " </tr>   "
			+ " <tr>"
			+ "    <td style='width:10%'> " + ($("#afectacion_otro").val())+" </td>"
			+ "    <td style='width:10%'> " + ($("#otro_leve").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#otro_moderada").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#otro_severa").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'> " + ($("#otro_muysevera").is(':checked') ? "X" : "") + " </td>"
			+ " </tr>   "
			+ " 		<tr>"
			...
			+ "    <td style='width:10%'> " + ($("#aflorante").is(':checked') ? "X" : "") + " </td>"
			...
			+ "    <td style='width:10%'> " + ($("#no_aflorante").is(':checked') ? "X" : "") + " </td>"
			...
			+ "    <td width='100%' colspan='4'><p></p>Los presentes están de acuerdo con la evaluación efectuada y en constancia firman siendo las  _______ horas del día ______ del mes  de  ______________ de 201___.</td></tr>"
                        ...
                        + "       <tbody>"
                        + "            <tr>"
                        + "              <td class='rotate'><div>pre-ero-"+(padDigits($("#customActa").val(), 3))+"-02</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-ero-" + ac +"-"+ 2 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate'><div>pre-ero-"+(padDigits($("#customActa").val(), 3))+"-01</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-ero-" + ac +"-"+ 1 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "            <tr>"
                        + "              <td class='rotate'><div>pre-ero-"+(padDigits($("#customActa").val(), 3))+"-04</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-ero-" + ac +"-"+ 4 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate' ><div>pre-ero-"+(padDigits($("#customActa").val(), 3))+"-03</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-ero-" + ac +"-"+ 3 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "         </tbody>"
                        + "       </table></p>"	
                        + "     <p style='page-break-after: always;'> "
                        ...
                        + "            <tr>"
                        + "            <tr>"
                        + "              <td class='rotate' style='height:650px;width:30px;'><div>pre-ero-"+(padDigits($("#customActa").val(), 3))+"-06</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-ero-" + ac +"-"+ 6 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate' style='height:650px;width:30px;'><div>pre-ero-"+(padDigits($("#customActa").val(), 3))+"-05</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-ero-" + ac +"-"+ 5 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "            <tr>"
                        + "              <td class='rotate' style='height:650px;width:30px;'><div>pre-ero-"+(padDigits($("#customActa").val(), 3))+"-07</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-ero-" + ac +"-"+ 7 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate' style='height:650px;width:30px;'><div>pre-ero-"+(padDigits($("#customActa").val(), 3))+"-08</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-ero-" + ac +"-"+ 8 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "         </tbody>"
                        + "       </table></p>"
			+ "   </body></html>",
