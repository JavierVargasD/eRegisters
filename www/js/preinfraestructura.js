...
function generatePDF() {
    ...
    var failure = function(status) {
     ...
     pdf.htmlToPDF({
            ...
            + "    <tbody>"
            + "      <tr><td style='width: 10%;height=75px'><img width='90' height='60' src='file:///storage/emulated/0/Download/Download/logo.PNG'></td>"
            + "      <td style='width: 80%;height:75px;text-align:center;font-size:18px'>ACTA PRE REGISTRO DE INFRAESTRUCTURA</td><td>FR-QHSE-29<p style='font-size:11px'>V2  23-03-2018</p></td></tr></tbody></table></td>"
            + "   </tr>"
            + "   <tr>"
            ...
            + "  <td style='width: 12.5%'>  pre-inf-" + $("#customActa").val() +" </td>"
            + "   </tr>    "
            + "  </tbody>"
            + "</table>"  
			...
			+ "    <td style='width:10%'> " + ($("#laminar").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'>Caídas:</td>"
			+ "    <td style='width:10%'> " + ($("#caidas").is(':checked') ? "X" : "") + " </td>"
			+ "</tr>"
			+ "<tr>"
			...
			+ "    <td style='width:10%'> " + ($("#surcos").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'>Deslizamientos:</td>"
			+ "    <td style='width:10%'> " + ($("#deslizamientos").is(':checked') ? "X" : "") + " </td>"
			+ "</tr>"
			+ "<tr>"
			...
			+ "    <td style='width:10%'> " + ($("#carcavas").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'>Volcamiento:</td>"
			+ "    <td style='width:10%'> " + ($("#volcamiento").is(':checked') ? "X" : "") + " </td>"
			+ "</tr>"
			+ "<tr>"
			...
			+ "    <td style='width:10%'> " + ($("#socavacion").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'>Flujos:</td>"
			+ "    <td style='width:10%'> " + ($("#flujos").is(':checked') ? "X" : "") + " </td>"
			+ "</tr>"
			+ "<tr>"
			...
			+ "    <td style='width:10%'> " + ($("#erosion_ninguno").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'>Ninguno:</td>"
			+ "    <td style='width:10%'> " + ($("#mov_ninguno").is(':checked') ? "X" : "") + " </td>"
			+ "</tr>"
			+ "<tr>"
			+ "    <td tyle='width:100%' colspan='10'> Topografia:   " + ($("#topografia").val())+"  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Tiempo de construccion:  " + ($("#tiempo_construccion").val())+" </td>"
			+ "</tr>"
			+ "<tr>"
			+ "    <td tyle='width:100%' colspan='10' align='center'> Archivo de fotos: PRE-INF-________ Serial del: _______ al _______ No. de fotos ______</td>"
			+ "</tr>"
			+ "<tr>"
			...
			+ "    <td style='width:14%'> " + ($("#socavamiento").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:11%'>Permanente:</td>"
			+ "    <td style='width:11%'> " + ($("#caudal_permanente").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:11%'>Pesado:</td>"
			+ "    <td style='width:11%'> " + ($("#trafico_pesado").is(':checked') ? "X" : "") + " </td>"
			+ "</tr>"
			+ "<tr>"
			+ "    <td style='width:14%'>Largo:</td>"
			+ "    <td style='width:14%'> " + ($("#largo").val())+" </td>"
			+ "    <td style='width:14%'>Erosión:</td>"
			+ "    <td style='width:14%'> " + ($("#erosion").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:11%'>Intermitente:</td>"
			+ "    <td style='width:11%'> " + ($("#caudal_intermitente").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:11%'>Liviano:</td>"
			+ "    <td style='width:11%'> " + ($("#trafico_liviano").is(':checked') ? "X" : "") + " </td>"
			+ "</tr>"
			+ "<tr>"
			+ "    <td style='width:14%'>Altura:</td>"
			+ "    <td style='width:14%'> " + ($("#altura").val())+" </td>"
			+ "    <td style='width:14%'>Desprendimientos:</td>"
			+ "    <td style='width:14%'> " + ($("#desprendimientos").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:11%'>Efímero:</td>"
			+ "    <td style='width:11%'> " + ($("#caudal_efimero").is(':checked') ? "X" : "") + " </td>"
			...
			+ "    <td style='width:14%'> " + ($("#volcamientos").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:11%'>Otro:</td>"
			...
			+ "    <td style='width:14%'> " + ($("#cizallamiento").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:22%' colspan='2'></td>"
			+ "    <td style='width:22%' colspan='2'></td>"
			+ "</tr>"
			+ "</tbody>"
			...
			+ "    <td style='width:5%'> " + ($("#constru_si").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:5%'>NO</td>"
			+ "    <td style='width:5%'> " + ($("#constru_no").is(':checked') ? "X" : "") + " </td>"
			+ "</tr>"
			+ "							<tr>"
			...
			+ "    <td width='100%' colspan='4'><p></p>Los presentes están de acuerdo con la evaluación efectuada y en constancia firman siendo las  _______ horas del día ______ del mes  de  ______________ de 201___.</td></tr>"
			        + "<tr>"
                        ...
                        + "       <tbody>"
                        + "            <tr>"
                        + "              <td class='rotate'><div>pre-inf-"+(padDigits($("#customActa").val(), 3))+"-02</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-inf-" + ac +"-"+ 2 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate'><div>pre-inf-"+(padDigits($("#customActa").val(), 3))+"-01</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-inf-" + ac +"-"+ 1 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "            <tr>"
                        + "              <td class='rotate'><div>pre-inf-"+(padDigits($("#customActa").val(), 3))+"-04</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-inf-" + ac +"-"+ 4 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate' ><div>pre-inf-"+(padDigits($("#customActa").val(), 3))+"-03</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-inf-" + ac +"-"+ 3 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "         </tbody>"
                        + "       </table></p>"	
                        + "     <p style='page-break-after: always;'> "
                        ...
                        + "            <tr>"
                        + "            <tr>"
                        + "              <td class='rotate' style='height:650px;width:30px;'><div>pre-inf-"+(padDigits($("#customActa").val(), 3))+"-06</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-inf-" + ac +"-"+ 6 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate' style='height:650px;width:30px;'><div>pre-inf-"+(padDigits($("#customActa").val(), 3))+"-05</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-inf-" + ac +"-"+ 5 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "            <tr>"
                        + "              <td class='rotate' style='height:650px;width:30px;'><div>pre-inf-"+(padDigits($("#customActa").val(), 3))+"-07</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-inf-" + ac +"-"+ 7 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate' style='height:650px;width:30px;'><div>pre-inf-"+(padDigits($("#customActa").val(), 3))+"-08</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-inf-" + ac +"-"+ 8 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "         </tbody>"
                        + "       </table></p>"		
			+ "</body></html>",
