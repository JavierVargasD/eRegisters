        ...
        myDB.transaction(function(transaction) {
            transaction.executeSql(query, [], function(tx, results) {
                ...
                for (i = 0; i < len; i++) {
					...
					$("#caudal_otro").val(results.rows.item(i).caudal_otro);
...
function generatePDF() {
    ...
    var failure = function(status) {
     ...
     pdf.htmlToPDF({
			...
			+ "<tbody>"
			+ "<tr>"
			+ "    <td style='width:40%' class='encabezado' colspan='4'><b>1. LOCALIZACIÓN</b></td>"
			+ "    <td style='width:20%' class='encabezado' colspan='2'><b>2. UBICACIÓN</b></td>"
			+ "    <td style='width:40%' class='encabezado' colspan='4'><b>3. PROCESOS EROSIVOS CERCANOS</b></td>"
			+ "</tr>"
			+ "<tr>"
			+ "    <td style='width:10%' >Departamento:</td>"
			+ "    <td  colspan='3'>  " + ($("#P_DEPTO option:selected").text())+" </td>"
			+ "    <td >Origen de coord:</td>"
			+ "    <td  style='width:5%' > " + ($("#origen_coord").val())+" </td>"
			...
			+ "<tr>"
			+ "    <td >Municipio:</td>"
			+ "    <td  colspan='3'>  " + ($("#P_MUN option:selected").text())+" </td>"
			+ "    <td >Coordenada E:</td>"
			...
			+ "<tr>"
			+ "    <td >Propietario:</td>"
			+ "    <td  colspan='3'>  " + ($("#propietario").val())+" </td>"
			+ "    <td >Stk:</td>"
			+ "    <td > " + ($("#stk").val())+" </td>"
			...
			+ "    <td style='width:10%;text-align:center'> " + ($("#erosivos_ninguno").is(':checked') ? "X" : "") + " </td>"
			+ "    <td style='width:10%'>Ninguno:</td>"
            ...
            + "    <td><img  src='file:///storage/emulated/0/Download/infraLine.png' style='width: 99%;  height: auto;'></td>"
			+ " </tr>"
                        + "</tbody>"
			+ "</table>"
			...
			+ "</tr>"
			+ "<tr>"
			+ "    <td width='100%' colspan='4'><p></p>Los presentes están de acuerdo con la evaluación efectuada y en constancia firman siendo las  _______ horas del día ______ del mes  de  ______________ de 202___.</td></tr>"
			        + "<tr>"
                        ...
                        + "     <td>Teléfono_______________</td><td>C.C #____________________________ de ________________________</td>"
                        + " </tr>"  
                        + "</table>"
						+ "<table width='100%'>"
						+ " <tr>"
						...
						+ "</tr>"
						+" <tr>"
						+ "     <td></td><td></td><td>C.C #____________________________ de ________________________</td>"
						+ " </tr>"  
						+" <tr>"
						...
						+ "</tr>"
						+" <tr>"
						+ "     <td></td><td></td><td colspan='2'>C.C #____________________________ de ________________________</td>"
						+ " </tr>"   
						+" <tr>"
						+ "     <td></td><td></td><td>TP_______________</td>"
						+ " </tr>"  
...
function insertUpdate() {
	...
	var caudal_otro = $("#caudal_otro").val();
