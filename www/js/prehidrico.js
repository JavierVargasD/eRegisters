...
function generatePDF() {
    ...
    pdf.htmlToPDF({
			...
			+ "    <td style='width:15%' class='encabezado' colspan='2'><b>3. ESTADO DEL PUNTO</b></td> "
			+ "    <td style='width:15%' class='encabezado' colspan='2'><b>4. FUENTE DE INFORMACIÓN</b></td> "
			+ "</tr> "
			+ "<tr> "
			+ "    <td style='width:10%'>Departamento:</td> "
			+ "    <td style='width:30%'>  " + ($("#P_DEPTO option:selected").text())+" </td> "
			+ "    <td style='width:15%'>Origen de coord:</td> "
			+ "    <td style='width:15%'> " + ($("#origen_coord").val())+ " </td> "
			+ "    <td style='width:10%'>Productivo:</td> "
			+ "     <td style='width:5%;text-align:center'> " + ($("#productivo").is(':checked') ? "X" : "") + " </td> "
			+ "<td style='width:10%'>En campo:</td> "
			+ "     <td style='width:5%;text-align:center'> " + ($("#en_campo").is(':checked') ? "X" : "") + " </td>      "
			+ "</tr> "
			+ "<tr> "
