        ...
        myDB.transaction(function(transaction) {
            transaction.executeSql(query, [], function(tx, results) {
                ...
                for (i = 0; i < len; i++) {
					...
					$("#jagüey").prop('checked', JSON.parse(results.rows.item(i).jagüey));
...
function generatePDF() {
    ...
    pdf.htmlToPDF({
			...
			+ " <body> "
                         ...
                         + "      <td style='width: 80%;height:75px;text-align:center;font-size:18px'>ACTA PRE REGISTRO DE RECURSO HÍDRICO</td><td>FR-QHSE-26<p style='font-size:11px'>V2  23-03-2018</p></td></tr></tbody></table></td>"
                         + "   </tr>"
                         + "   <tr>"
                         ...
                         + "  <td style='width: 12.5%'>  pre-hid-" + $("#customActa").val() +" </td>"
                         + "   </tr>    "
                         + "  </tbody>"
                         + "</table>"
			...
			+ "     <td style='width:10%'> " + ($("#productivo").is(':checked') ? "X" : "") + " </td> "
			+ "<td style='width:10%'>En campo:</td> "
			+ "     <td style='width:10%'> " + ($("#en_campo").is(':checked') ? "X" : "") + " </td>      "
			+ "</tr> "
			+ "<tr> "
			...
			+ "     <td style='width:10%'> " + ($("#reserva").is(':checked') ? "X" : "") + " </td> "
			+ "<td style='width:10%'>Constructor:</td> "
			+ "     <td style='width:10%'> " + ($("#constructor").is(':checked') ? "X" : "") + " </td> "
			+ "</tr> "
			+ "<tr> "
			...
			+ "     <td style='width:10%'>" + ($("#abandonado").is(':checked') ? "X" : "") + "</td> "
			+ "<td style='width:10%'>Propietario:</td> "
			+ "     <td style='width:10%'> " + ($("#propietario_i").is(':checked') ? "X" : "") + " </td> "
			+ "</tr> "
			+ "<tr> "
			...
			+ "     <td style='width:10%'>" + ($("#inactivo").is(':checked') ? "X" : "") + "</td> "
			+ "<td style='width:10%'>Estudios:</td> "
			+ "     <td style='width:10%'> " + ($("#estudios").is(':checked') ? "X" : "") + " </td>      "
			+ "</tr> "
			+ "<tr> "
			...
			+ "     <td style='width:10%'>" + ($("#sellado").is(':checked') ? "X" : "") + "</td> "
			+ "<td style='width:10%'>Reportes:</td> "
			+ "     <td style='width:10%'> " + ($("#reportes").is(':checked') ? "X" : "") + " </td>      "
			+ "</tr> "
			+ "<tr> "
			...
			+ "     <td style='width:10%'>" + ($("#monitoreo").is(':checked') ? "X" : "") + "</td> "
			+ "<td style='width:10%'>Otros:</td> "
			+ "     <td style='width:10%'> " + ($("#otros").is(':checked') ? "X" : "") + " </td>      "
			+ "</tr> "
			+ "    </tbody> "
			+ "</table> "
			+ "<table width='100%' border='1' cellspacing='0' cellpadding='0'> "
			...
			+ "    <td style='text-align: justify'><p></p> En el municipio de  " + ($("#P_MUN option:selected").text())+"  vereda o barrio  " + ($("#vereda").val())+ "  del departamento de  " + ($("#P_DEPTO option:selected").text())+", se reunieron el funcionario (a) "+window.localStorage.getItem('representante')+" con c&#233;dula de ciudadania "+window.localStorage.getItem('numdocrepre')+" de "+window.localStorage.getItem('lugarcc')+" quien actua como evaluador  y el (la) señor (a) " + ($("#propietario").val())+ ", con cédula de  ciudadanía N° " + ($("#cc_propietario").val())+ "  de " + ($("#lugar_cc_propietario").val())+ ", en calidad de propietario(a) o representante del predio, con el fin de realizar una evaluación al estado de un recurso hídrico y demás anexos a este, que se describe a continuación:<p></p></td>                </tr> "
			+ "    </tbody> "
			+ "</table> "
			+ " <table width='100%' border='1' cellspacing='0' cellpadding='0'> "
			+ "    <tbody> "
			...
			+ "    <td style='width:10%'> " + ($("#invierno").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:15%'>Doméstico:</td> "
			+ "    <td style='width:15%'> " + ($("#domestico").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:15%'>Cementerio:</td> "
			+ "     <td style='width:5%'> " + ($("#cementerio").is(':checked') ? "X" : "") + " </td> "
			+ "<td style='width:15%'>Tipo de Suelo:</td> "
			+ "     <td style='width:15%' colspan='4'> " + ($("#tipo_suelo").val())+ " </td>    "
			+ " </tr> "
			+ "<tr> "
			+ "    <td style='width:10%'>Verano:</td> "
			+ "    <td style='width:10%'> " + ($("#verano").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:15%'>Comunitario:</td> "
			+ "    <td style='width:15%'> " + ($("#comunitario").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:15%'>Basura/Estiércol:</td> "
			+ "     <td style='width:5%'> " + ($("#basura_estiercol").is(':checked') ? "X" : "") + " </td> "
			...
			+ "    <td style='width:10%'> " + ($("#comienzo_invierno").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:15%'>Ganadero:</td> "
			+ "    <td style='width:15%'>SP  " + ($("#ganadero_sp").val())+ " &nbsp; &nbsp; &nbsp; #  " + ($("#ganadero_n").val())+ " </td> "
			+ "    <td style='width:15%'>Aguas estancadas:</td> "
			+ "     <td style='width:5%'> " + ($("#aguas_estancadas").is(':checked') ? "X" : "") + " </td> "
			+ "<td style='width:15%'>Aporte de agua permanente:</td> "
			+ "     <td style='width:15%' colspan='4'> " + ($("#aporte_agua_permanente").is(':checked') ? "X" : "") + " </td>      "
			+ "</tr> "
			+ "<tr> "
			+ "    <td style='width:10%'>Comienzo de Verano:</td> "
			+ "    <td style='width:10%'> " + ($("#comienzo_verano").is(':checked') ? "X" : "") + " </td> "
			...
			+ "    <td style='width:10%'> " + ($("#manguera_gravedad").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:12%'>Manual:</td> "
			+ "    <td style='width:8%'> " + ($("#capta_manual").is(':checked') ? "X" : "") + " </td> "
			...
			+ "    <td style='width:10%'> " + ($("#manguera_bombeo").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:12%'>Bomba sumergible:</td> "
			+ "     <td style='width:8%'> " + ($("#bomba_sumergible").is(':checked') ? "X" : "") + " </td> "
			...
			+ "    <td style='width:10%'> " + ($("#canal_tierra").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:12%'>Bomba natural:</td> "
			+ "     <td style='width:8%'> " + ($("#bomba_natural").is(':checked') ? "X" : "") + " </td> "
			...
			+ "    <td style='width:10%'> " + ($("#canal_cemento").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:12%'>Electrobomba:</td> "
			+ "     <td style='width:8%'> " + ($("#electrobomba").is(':checked') ? "X" : "") + " </td> "
			...
			+ "            <td style='width:5.3%'> " + ($("#manantial_goteo").is(':checked') ? "X" : "") + " </td> "
			...
			+ "            <td style='width:5.3%'> " + ($("#manantial_filtracion").is(':checked') ? "X" : "") + " </td> "
			...
			+ "            <td style='width:5.3%'> " + ($("#perma_perenne").is(':checked') ? "X" : "") + " </td> "
			...
			+ "         </td><td style='width:5.3%'> " + ($("#perma_intermitente").is(':checked') ? "X" : "") + " </td> "
			...
			+ "            <td style='width:5.3%'> " + ($("#perma_sininfo").is(':checked') ? "X" : "") + " </td> "
			...
			+ "            <td style='width:5.3%'> " + ($("#surgencia_kastico").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:17.3%'>Concreto:</td> "
			+ "    <td style='width:16%'> " + ($("#material_concreto").is(':checked') ? "X" : "") + " </td> "
			...
			+ "            <td style='width:5.3%'> " + ($("#surgencia_fracturas").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:17.3%'>Bloque arena-cemento:</td> "
			+ "    <td style='width:16%'> " + ($("#material_bloque").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:17%'>Tamaño/peso:</td> "
			+ "    <td style='width:16%' colspan='4'> " + ($("#jaguey_tamano").val())+ " </td></tr> "
			+ " <tr><td style='width:13%'>Contacto</td> "
			+ "            <td style='width:5.3%'> " + ($("#surgencia_contacto").is(':checked') ? "X" : "") + " </td> "
			+ "    <td style='width:17.3%'>PVC:</td> "
			+ "    <td style='width:16%'> " + ($("#material_pvc").is(':checked') ? "X" : "") + " </td> "
			...
			+ "    <td style='width:16%'> " + ($("#material_metalico").is(':checked') ? "X" : "") + " </td> "
			...
			+ " <td style='width:8%'> " + ($("#topo_depresion").is(':checked') ? "X" : "") + " </td> "
			+ " <td style='width:12%'>Abanico Aluvial:</td> "
			+ " <td style='width:8%'> " + ($("#geo_abanico_aluvial").is(':checked') ? "X" : "") + " </td> "
			...
			+ " <td style='width:8%'> " + ($("#topo_planicie").is(':checked') ? "X" : "") + " </td> "
			+ " <td style='width:12%'>Cauce Aluvial:</td> "
			+ " <td style='width:8%'> " + ($("#geo_cauce_aluvial").is(':checked') ? "X" : "") + " </td> "
			...
			+ " <td style='width:8%'> " + ($("#topo_altiplanicie").is(':checked') ? "X" : "") + " </td> "
			+ " <td style='width:12%'>Llanura Aluvial:</td> "
			+ " <td style='width:8%'> " + ($("#geo_llanura_aluvial").is(':checked') ? "X" : "") + " </td> "
			...
			+ " <td style='width:8%'> " + ($("#topo_piedemonte").is(':checked') ? "X" : "") + " </td> "
			+ " <td style='width:12%'>Terraza:</td> "
			+ " <td style='width:8%'> " + ($("#geo_terraza").is(':checked') ? "X" : "") + " </td> "
			...
			+ " <td style='width:8%'> " + ($("#topo_ladera").is(':checked') ? "X" : "") + " </td> "
			+ " <td style='width:12%'>Luna:</td> "
			+ " <td style='width:8%'> " + ($("#geo_luna").is(':checked') ? "X" : "") + " </td> "
			+ " <td style='width:10%'></td> "
			...
			+ " <td style='width:8%'> " + ($("#topo_colina").is(':checked') ? "X" : "") + " </td> "
			+ " <td style='width:12%'>Colina:</td> "
			+ " <td style='width:8%'> " + ($("#geo_dolina").is(':checked') ? "X" : "") + " </td> "
			...
			+ " <td style='width:8%'> " + ($("#geo_playa").is(':checked') ? "X" : "") + " </td> "
			+ " <td style='width:10%'><b></b></td> "
			+ "    <td style='width:50%' colspan='6'></td> "
			+ " </tr>  "
			+ " <tr> "
			...
			+ "</table>"
                        ...
                        + "       <tbody>"
                        + "            <tr>"
                        + "              <td class='rotate'><div>pre-hid-"+(padDigits($("#customActa").val(), 3))+"-02</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-hid-" + ac +"-"+ 2 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate'><div>pre-hid-"+(padDigits($("#customActa").val(), 3))+"-01</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-hid-" + ac +"-"+ 1 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "            <tr>"
                        + "              <td class='rotate'><div>pre-hid-"+(padDigits($("#customActa").val(), 3))+"-04</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-hid-" + ac +"-"+ 4 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate' ><div>pre-hid-"+(padDigits($("#customActa").val(), 3))+"-03</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-hid-" + ac +"-"+ 3 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "         </tbody>"
                        + "       </table></p>"	
                        + "     <p style='page-break-after: always;'> "
                        ...
                        + "            <tr>"
                        + "            <tr>"
                        + "              <td class='rotate' style='height:650px;width:30px;'><div>pre-hid-"+(padDigits($("#customActa").val(), 3))+"-06</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-hid-" + ac +"-"+ 6 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate' style='height:650px;width:30px;'><div>pre-hid-"+(padDigits($("#customActa").val(), 3))+"-05</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-hid-" + ac +"-"+ 5 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "            <tr>"
                        + "              <td class='rotate' style='height:650px;width:30px;'><div>pre-hid-"+(padDigits($("#customActa").val(), 3))+"-07</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-hid-" + ac +"-"+ 7 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "              <td  class='rotate' style='height:650px;width:30px;'><div>pre-hid-"+(padDigits($("#customActa").val(), 3))+"-08</div></td>"
                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-hid-" + ac +"-"+ 8 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                        + "            </tr>"
                        + "         </tbody>"
                        + "       </table></p>"
        		+ "</body></html>",
