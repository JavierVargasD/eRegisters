...
function generatePDF() {
	...
	$.each(JSON.parse(arteData), function(i, item) {
		...
		var obrasRowHtml = 	
				"<tr>"
				   +"<td style='width:2%;height:200px'><b>"+ j +"</b></td>"
			...
			+"</tr>";
                        ...
                        if(j==3 || j==9 || j==15 || j==21 || j==27 || j==33 || j==39 || j==45 || j==51 || j==57 || j==63 || j==69 || j==75){
                            obrasRowsHtml += obrasRowHtml + "</table><p style='page-break-after: always;'><table border='1' cellspacing='0' cellpadding='0'>"+encabezado;
                        } else {
	...
	$.each(JSON.parse(patoData), function(i, item) {
		...
		var patoRowHtml = 	
			...
			+"</tr>";
                        ...
                        if(j==10 || j==22 || j==34 || j==46 || j==58 || j==70 || j==82 ){
                            patoRowsHtml += patoRowHtml + "</table><p style='page-break-after: always;'><table border='1' cellspacing='0' cellpadding='0'>"+encabezadoPatos;
                        } else {
    ...
    pdf.htmlToPDF({
            data:"<!DOCTYPE html>"
                    ...
                    + "  <td style='width: 12.5%'>  pre-vial-" + $("#customActa").val() +" </td>"
					...
					+ " </tr> "
					+ " <tr>"
					//+ "  <td style='width:100%' align='justify'><p></p>En compañía de " + ($("#repcomu").val())+" quien(es) actúa(n) como " + ( $("#texcom").val() )+ " y "+window.localStorage.getItem('representante')+" quien actúa como evaluador, el día " + ($("#dia").val())+" de " + ($("#mes").val() )+" de " + ($("#ann").val() )+"  en el municipio de " + ($("#P_MUN option:selected").text())+" del departamento de " + ($("#P_DEPTO option:selected").text())+", se realizó la evaluación y el registro fílmico y fotográfico del tramo de la vía en mención, cuya longitud aproximada es de  " + ($("#longg").val() )+"  Km., que sirve como acceso  " + ($("#access").val() )+"; en consideración a esto se referencia lo siguiente: "
					...
					+ "  </tbody>"
					+ "</table>"
					+ "<table width='100%' border='1' cellspacing='0' cellpadding='0' style='border: 2px solid black;' colspan='34'>"
					+ "   <tr>"
					...
					+ "    <tbody>"
					+ "   <tr>"
					+ "  <td class='encabezado' style='text-align: justify;'><b>OBSERVACIONES GENERALES DE LA VIA</b></td>"
					+ "   </tr>"
					+ "   <tr>"
					+ "  <td style='height: 100px;vertical-align: top;padding:5px'>  " + ($("#concepto_general").val())+" </td>"
					+ "   </tr>"
					+ "    </tbody>"
					+ "</table>"
					...
					+ " </tr>"
                                        +" <tr>"
                                        + "     <td width='45%'>NOMBRE DEL REPRESENTANTE DE LA ENTIDAD RESPONSABLE DE LA VIA</td><td  width='45%'>FIRMA DEL REPRESENTANTE DE LA ENTIDAD RESPONSABLE DE LA VIA</td>"
					+ " </tr>"
					...
					+ "       <tbody>"
                                	+ "            <tr>"
					+ "              <td class='rotate'><div>pre-vial-"+(padDigits($("#customActa").val(), 3))+"-02</div></td>"
                                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-vial-" + ac +"-"+ 2 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                                        + "              <td  class='rotate'><div>pre-vial-"+(padDigits($("#customActa").val(), 3))+"-01</div></td>"
                                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-vial-" + ac +"-"+ 1 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
					+ "            </tr>"
                                	+ "            <tr>"
					+ "              <td class='rotate'><div>pre-vial-"+(padDigits($("#customActa").val(), 3))+"-04</div></td>"
                                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-vial-" + ac +"-"+ 4 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                                        + "              <td  class='rotate' ><div>pre-vial-"+(padDigits($("#customActa").val(), 3))+"-03</div></td>"
                                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-vial-" + ac +"-"+ 3 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
					+ "            </tr>"
 					+ "         </tbody>"
					+ "       </table></p>"	
                                	+ "     <p style='page-break-after: always;'> "
					...
					+ "       <tbody>"
                                	+ "            <tr>"
                                	+ "            <tr>"
					+ "              <td class='rotate' style='height:650px;width:30px;'><div>pre-vial-"+(padDigits($("#customActa").val(), 3))+"-06</div></td>"
                                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-vial-" + ac +"-"+ 6 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                                        + "              <td  class='rotate' style='height:650px;width:30px;'><div>pre-vial-"+(padDigits($("#customActa").val(), 3))+"-05</div></td>"
                                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-vial-" + ac +"-"+ 5 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
					+ "            </tr>"
                                	+ "            <tr>"
					+ "              <td class='rotate' style='height:650px;width:30px;'><div>pre-vial-"+(padDigits($("#customActa").val(), 3))+"-07</div></td>"
                                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-vial-" + ac +"-"+ 7 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
                                        + "              <td  class='rotate' style='height:650px;width:30px;'><div>pre-vial-"+(padDigits($("#customActa").val(), 3))+"-08</div></td>"
                                        + "              <td  style='width:400px;'><img src='"+ cordova.file.dataDirectory +"/files/pre-vial-" + ac +"-"+ 8 + ".jpg' style='transform:rotate(90deg);width: 500px;height: 360px'></td>"
					+ "            </tr>"
					+ "         </tbody>"
					+ "       </table></p>"			
...
function generarEncabezado() {
	    ...
	    var failure = function(status) {
            ...
            var firstPage = "<table style='border-top: 1px solid' width='100%' border='1' cellspacing='0' cellpadding='0'>"
                        ...
                        + "  <td style='width: 12.5%'>  " + ($("#linea").val())+" </td>"
                        + "  <td style='width: 12.5%'>Acta Nº.</td>"
                        + "  <td style='width: 12.5%'>  pre-vial-" + (padDigits(customActa, 3)) +" </td>"
                        + "   </tr>    "
                        + "  </tbody>"
                        + "</table>";
            ...
            for(;p <= pages; p++){                
                 ...
                 var headers = "<p style='page-break-after: always;'> "
                        ...
                        + "  <td colspan='4'>"
                        + "  <table width='100%' border='0' cellspacing='0' cellpadding='0'>"
                        + "    <tbody><tr><td style='width: 10%;height=75px'><img width='90' height='60' src='file:///storage/emulated/0/Download/logo.PNG'>"
                        + "      </td><td style='width: 80%;height:75px;text-align:center;font-size:18px'>ACTA PRE REGISTRO DE EVALUACIÓN VIAL</td><td>FR-QHSE-15<p style='font-size:11px'>V2  23-03-2018</p></td></tr></tbody></table></td>"
                        + "   </tr>"
                        + "   <tr>"
                        + "  <td style='width: 25%'>PROGRAMA SÍSMICO:</td>"
                        + "  <td>  "+ window.localStorage.getItem('programa_sismico') +" </td>"
